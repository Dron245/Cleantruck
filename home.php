					...
					<div class="body-bottom__cont">
						...
						<div class="body-bottom__controls">
							<button type="button" class="body-bottom__arrow body-bottom__arrow_left">
								<img src="<?php bloginfo('template_url'); ?>/assets/img/main/arrow-right.svg" alt="">
							</button>
						...
						<div class="sld__slider">
							<div class="sld__swiper">
								<div class="sld__slide -ibg">
									<picture><source srcset="<?php bloginfo('template_url'); ?>/assets/img/main/minabout-01.webp" type="image/webp"><img src="<?php bloginfo('template_url'); ?>/assets/img/main/minabout-01.jpg" alt=""></picture>
								</div>
								<div class="sld__slide -ibg">
									<picture><source srcset="<?php bloginfo('template_url'); ?>/assets/img/main/minabout-01.webp" type="image/webp"><img src="<?php bloginfo('template_url'); ?>/assets/img/main/minabout-01.jpg" alt=""></picture>
								</div>
