(() => {
    ...
    function initSliders() {
        bildSliders();
        if (document.querySelector(".body-bottom__slider")) {
            const thumbsSwiper = new core(".body-bottom__slider", {
                modules: [ Thumb, Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 0,
                spaceBetween: 30,
        ...
        if (document.querySelector(".sld__slider")) new core(".sld__slider", {
